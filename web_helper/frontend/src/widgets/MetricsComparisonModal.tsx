...
import { useRunDetail } from '@/app/ui/ChartInteractionContext';
import { saveView, updateView, getProjectSavedViews, type SavedView } from '@/shared/lib/saved-views';
import { useMetricsTimeseries } from '@/shared/model/useMetricsTimeseries';
import { EmptyState } from '@/entities/chart/EmptyState';
import { ScrollArea } from '@shared/ui/scroll-area';

// Direct imports (not lazy) to avoid dynamic import issues
import { OverviewTab } from '@/widgets/OverviewTab';
import { TrainingTab } from '@/widgets/TrainingTab';
import { AnalysisTab } from '@/widgets/AnalysisTab';
import { DetailsTab } from '@/widgets/DetailsTab';
import {
  Save,
  Eye,
  TrendingUp,
