...
import type { ChartRenderer, ChartType } from '@/shared/lib/charts/types';
import { getAvailableRenderers } from '@/shared/lib/charts/UniversalChart';
import { isCompatible } from '@/shared/lib/charts/types';
