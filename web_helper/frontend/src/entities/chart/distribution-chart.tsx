...
import { UniversalChart } from '@/shared/lib/charts/UniversalChart';
import { ChartRendererSelector } from '@/shared/ui/chart-renderer-selector';
import { ChartSettingsPanel, ChartSettings } from '@/entities/chart/ChartSettingsPanel';
import { ChartExportButton } from '@/entities/chart/ChartExportButton';
import type { ChartRenderer, ChartExportOptions } from '@/shared/lib/charts/types';
...
export function DistributionChart({
  ...
  const handleExport = async (options: ChartExportOptions) => {
    ...
    } else if (options.format === 'png' && chartRef.current) {
      try {
    ...
    } else if (options.format === 'svg' && chartRef.current) {
      try {
