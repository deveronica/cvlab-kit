...
import { useChartSettings, HistogramSettings, getColorScheme } from '@/shared/model/chart-settings';
 ...
 */
function convertToCSV(data: BinData[], stats: DistributionStats): string {
