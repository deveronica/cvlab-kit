...
import { flattenObject } from '@/shared/lib/table-columns';
import { DistributionChart as RichDistributionChart } from '@/entities/chart/DistributionChart';
import { ScatterPlotChart } from '@/entities/chart/scatter-plot-chart';
import { CustomizableChartCard } from '@/entities/chart/CustomizableChartCard';
import CorrelationHeatmap from '@/entities/chart/CorrelationHeatmap';
import { spearmanr } from '@/shared/lib/statistics';
import type { SeriesConfig } from '@/shared/lib/charts/types';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@shared/ui/select';
import type { Run } from '@/shared/model/types';
import { transformForDistribution } from '@/shared/lib/chartDataTransformers';
