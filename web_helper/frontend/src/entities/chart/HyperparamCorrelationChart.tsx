...
import type { ExportFormat } from '@/shared/ui/export-menu';
import type { Run } from '@/shared/model/types';
import { transformForCorrelation } from '@/shared/lib/chartDataTransformers';
import { useChartExport } from '@/shared/model/useChartExport';
import { useChartSettings, ScatterSettings, getColorScheme } from '@/shared/model/chart-settings';
        ...
        <ScatterChart margin={{ top: 10, right: 30, left: 10, bottom: 10 }}>
          ...
          <Scatter
            ...
            onClick={(data: unknown) => {
              const d = data as { runName?: string };
              if (onPointClick && d.runName) {
                onPointClick(d.runName);
              }
            }}
            cursor="pointer"
          />
