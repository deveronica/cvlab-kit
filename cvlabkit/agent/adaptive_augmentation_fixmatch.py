...
class AdaptiveAugmentationFixmatch(Agent):
    ...
    def _stratified_split(self, targets: np.ndarray, num_labeled: int):
        ...
        # Calculate the number of labeled samples per class.
    ...
    def train_step(self, labeled_batch, unlabeled_batch):
        ...
        #       loss_contrastive = self.contrastive_loss_fn(features_weak, features_strong)
        loss_contrastive = self.contrastive_loss_fn(student_preds, teacher_preds).mean()
