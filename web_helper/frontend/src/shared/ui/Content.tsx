...
import { RunsTable } from '@/shared/tables/RunsTable';
import { DevicesTable } from '@/shared/tables/DevicesTable';
import { ComponentsPage } from '@/shared/pages/ComponentsPage';
...
export function Content({ activeView, activeProject }: ContentProps) {
  ...
  if (activeView === 'projects' && activeProject) {
    const handleRunClick = (run: { name?: string; status?: string }) => {
