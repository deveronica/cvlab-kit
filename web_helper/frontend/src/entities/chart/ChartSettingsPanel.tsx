...
import type { LegendConfig, AxisConfig, ChartRenderer } from '@/shared/lib/charts/types';
...
const RENDERER_FEATURES = {
  ...
  chartjs: {
    ...
    stackMode: true,        // ✓ Implemented: stacked scales + stack property
                    ...
                    {chartType === 'line' && features.curveType && (
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value: string) => updateSetting('curveType', value)}
                        >
                ...
                <div className="border-t pt-3 space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value: string) => updateSetting('stackMode', value)}
                    >
                ...
                <>
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value: string) => updateLegend({ position: value })}
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value: string) => updateLegend({ align: value })}
                    >
                ...
                {features.yAxisScale && (
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value: string) => updateYAxis({ scale: value })}
                    >
              ...
              <div className="space-y-3">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value: string) => updateHeatmap({ colorPalette: value })}
                  >
