...
import { devLog } from '@/shared/lib/utils';
          ...
          <ResponsiveContainer width="100%" height={400}>
            <LineChart data={filteredData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
              ...
              <Brush
                ...
                onChange={(domain: unknown) => {
                  const d = domain as { startIndex?: number; endIndex?: number };
                  if (d && d.startIndex !== undefined && d.endIndex !== undefined) {
                    const start = filteredData[d.startIndex][xAxisKey];
                    const end = filteredData[d.endIndex][xAxisKey];
