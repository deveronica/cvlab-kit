...
class AdaptiveAugmentationFlow(Agent):
    ...
    def setup(self):
        ...
        # AdaptiveRandAugment needs to be instantiated separately
        # because it requires difficulty_score at call time
        from cvlabkit.component.transform.adaptive_rand_augment import AdaptiveRandAugment
        adaptive_cfg = self.cfg.get("transform", {}).get("adaptive_augment", {})
        from cvlabkit.core.config import Config
        self.adaptive_augment = AdaptiveRandAugment(Config(adaptive_cfg))
