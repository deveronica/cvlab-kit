...
import type { OutlierDetectionResponse } from '@/shared/api/outliers';
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent hideCloseButton className="max-w-4xl h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-hidden">
          <Tabs value={activeTab} onValueChange={(v: string) => setActiveTab(v as 'summary' | 'hyperparams' | 'metrics')} className="h-full flex flex-col">
