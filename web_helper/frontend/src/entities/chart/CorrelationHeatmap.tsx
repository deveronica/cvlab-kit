...
/**
 * Heatmap cell data: [xIndex, yIndex, correlationValue]
 */
type HeatmapCellData = [number, number, number];
    ...
    return {
      tooltip: {
        ...
        formatter: (params: CallbackDataParams) => {
          const p = params as CallbackDataParams & { data?: unknown[] };
          if (!p.data || p.data.length < 3) return '';
          const [xIdx, yIdx, value] = p.data as unknown[];
 ...
 */
function convertToCSV(data: HeatmapCellData[], xAxis: string[], yAxis: string[]): string {
